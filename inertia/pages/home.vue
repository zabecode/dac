  ...
  <div class="pt-4 h-full flex flex-col">
    ...
    <div class="grow mt-10 mb-8 px-16 xl:px-8 max-w-screen-xl mx-auto">
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <article
          class="relative py-4 px-5 glass border border-white/5 rounded-lg hover:border-accent/50 hover:shadow-sm transition duration-100 ease-in-out group">
          <h2 class="font-semibold text-white">
            <a href="https://lucid.adonisjs.com" target="_blank" class="flex flex-row gap-2">
              <span class="bg-accent/20 h-6 w-6 flex justify-center items-center rounded text-accent">
          ...
          <p class="mt-4 text-sm text-slate-400 group-hover:text-slate-200 transition ease-in-out duration-100">
          ...
          <svg
            class="absolute top-4 right-5 opacity-0 group-hover:opacity-100 text-accent w-4 h-4 transition ease-in-out duration-100"
            viewBox="0 0 24 24">
        ...
        <article
          ...
          <h2 class="font-semibold text-white">
            <a href="https://vinejs.dev/" target="_blank" class="flex flex-row gap-2">
              <span class="bg-purple-500/20 h-6 w-6 flex justify-center items-center rounded text-purple-400">
                <svg class="h-4 w-4 fill-current" viewBox="0 0 24 24">
                  <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    stroke-width="2" d="M12 3a12 12 0 0 0 8.5 3A12 12 0 0 1 12 21 12 12 0 0 1 3.5 6 12 12 0 0 0 12 3" />
                </svg>
              </span>
              <span>Vine</span>
              <span class="absolute inset-0"></span>
        ...
        <article
          ...
          <h2 class="font-semibold text-white">
            <a href="https://inertiajs.com/" target="_blank" class="flex flex-row gap-2">
              <span class="bg-cyan-500/20 h-6 w-6 flex justify-center items-center rounded text-cyan-400">
                <svg class="h-4 w-4 fill-current" viewBox="0 0 24 24">
                  <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    stroke-width="2" d="m12.5 8l4 4l-4 4H17l4-4l-4-4zm-9 0l4 4l-4 4H8l4-4l-4-4z" />
                </svg>
              </span>
              <span>InertiaJS</span>
              <span class="absolute inset-0"></span>
        ...
        <article
          ...
          <h2 class="font-semibold text-white">
            <a href="https://japa.dev" target="_blank" class="flex flex-row gap-2">
              <span class="bg-pink-500/20 h-6 w-6 flex justify-center items-center rounded text-pink-400">
                <svg class="h-4 w-4 fill-current" viewBox="0 0 256 256">
                  <path fill="currentColor"
